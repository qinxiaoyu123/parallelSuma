...
public class QueryReason {
    ...
    public static void type55Reason(int rs, int ro, List<Integer> head) {
        ...
        if (!ThreeKeyMap.checkDuplicate(ro, typeEncode, classValue)) {
            DicRdfDataMap.addNewRdfDataBeanParallel(ro, typeEncode, classValue);
        }
    }

    public static void type22Reason(int rs, List<Integer> head) {
        int class1 = head.get(0);
...
//            }
    ...
    public static void type21Reason(int rs, List<Integer> head) {
        int class1 = head.get(0);
...
//        if (ThreeKeyMap.checkDuplicate(rs, typeEncode, class1)) return;
    ...
    public static void type20Reason(int rs, List<Integer> head) {
        int class1 = head.get(0);
        int property = head.get(2);
        int class3 = head.get(3);
//        if (ThreeKeyMap.checkDuplicate(rs, typeEncode, class1)) return;
    ...
    public static void type19Reason(int rs, List<Integer> head) {
        int class1 = head.get(0);
...
//            }
    ...
    public static void type18Reason(int rs, int rp, List<Integer> head) {
        int class1 = head.get(0);
        int class3 = head.get(2);
        if (ThreeKeyMap.checkDuplicate(rs, typeEncode, class1)) return;
    ...
    public static void type16Reason(int rs, List<Integer> head) {
        //rs type class3
        int class1 = head.get(0);
        int class2 = head.get(1);
        int property = head.get(2);
    ...
    public static void type15Reason(int rs, List<Integer> head) {
        int class1 = head.get(0);
        int class2 = head.get(1);
        int property = head.get(2);
        int class3 = head.get(3);
    ...
    public static void type14Reason(int rs, List<Integer> head) {
        int class1 = head.get(0);
        int property = head.get(2);
        int class3 = head.get(3);
        int class4 = head.get(4);
    ...
    public static void type12Reason(int rs, int rp, List<Integer> head) {
        int class1 = head.get(0);
    ...
    public static void type11Reason(int ro, List<Integer> head) {
        int class1 = head.get(0);
        int property = head.get(1);
    ...
    public static void type10Reason(int rs, int ro, List<Integer> head) {
        int class1 = head.get(0);
    ...
    public static void equivalentClass3Reason(int ro, List<Integer> head) {
        int class1 = head.get(0);
        int class2 = head.get(1);
        int r = head.get(2);
    ...
    public static void equivalentRoleReason(int rs, int ro, List<Integer> head) {
        int class1 = head.get(0);
        int class2 = head.get(1);
        int class3 = head.get(3);
        if (ThreeKeyMap.checkDuplicate(rs, typeEncode, class1)) {
    ...
    public static void equivalentClass2Reason(int rs, List<Integer> head) {
        int class1 = head.get(0);
        int r = head.get(2);
        int class3 = head.get(3);
        if (ThreeKeyMap.checkDuplicate(rs, typeEncode, class1)) {
