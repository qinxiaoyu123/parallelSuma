...
public class DicSerialReason {
    ...
    public static void switchReasonType(Map<Integer, DicRdfDataBean> totalData, Map<Integer, DicRdfDataBean> stashMap, Map<Integer, DicRdfDataBean> iteratorMap, int rs, int rp, int ro, int type, List<Integer> head) {
        switch (type) {
...
//                break;
    ...
    public static void convertDataToRuleKey(List<String> ruleKey, int rp, int ro) {
